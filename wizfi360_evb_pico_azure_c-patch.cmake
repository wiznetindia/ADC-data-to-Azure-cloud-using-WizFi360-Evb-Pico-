...
if(NOT Git_FOUND)
	message(FATAL_ERROR "Could not find 'git' tool for WIZFI360-EVB-PICO-AZURE-C patching")
endif()

message("WIZFI360-EVB-PICO-AZURE-C patch utils found")

set(WIZFI360_EVB_PICO_AZURE_C_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
set(AZURE_IOT_SDK_C_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/azure-iot-sdk-c")
set(AZURE_IOT_SDK_C_UTILITY_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/azure-iot-sdk-c/c-utility")
set(AZURE_IOT_SDK_C_UAMQP_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/azure-iot-sdk-c/uamqp")
set(AZURE_IOT_SDK_C_UMQTT_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/azure-iot-sdk-c/umqtt")
set(CMSIS_5_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/CMSIS_5")
set(CMSIS_DRIVER_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/CMSIS-Driver")
set(CMSIS_FREERTOS_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/CMSIS-FreeRTOS")
set(IOT_SOCKET_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/IoT_Socket")
set(MBEDTLS_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/mbedtls")
set(PICO_EXTRAS_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/pico-extras")
set(PICO_SDK_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/pico-sdk")
set(PICO_SDK_TINYUSB_SRC_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/libraries/lib/tinyusb")
set(WIZFI360_EVB_PICO_AZURE_C_PATCH_DIR "${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR}/patches")
...
execute_process(COMMAND ${GIT_EXECUTABLE} -C ${WIZFI360_EVB_PICO_AZURE_C_SRC_DIR} submodule update --init)
...
file(GLOB CMSIS_FREERTOS_PATCHES
	"${WIZFI360_EVB_PICO_AZURE_C_PATCH_DIR}/01_cmsis_freertos_cmsis_os2.patch"
	)
